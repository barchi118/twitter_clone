            ...
            <div class="card">
                ...
                <div class="card-footer py-1 d-flex justify-content-end bg-white">
                    ...
                    <div class="d-flex align-items-center">
                        @if (!in_array(Auth::user()->id, array_column($tweet->favorites->toArray(), 'user_id'), TRUE))
                            <form method="POST" action="{{ url('favorites/') }}" class="mb-0">
                                ...
                                <button type="submit" class="btn p-0 border-0 text-primary"><i class="far fa-heart fa-fw"></i>いいね</button>
                            </form>
                        @else
                            <form method="POST"action="{{ url('favorites/' .array_column($tweet->favorites->toArray(), 'id', 'user_id')[Auth::user()->id]) }}" class="mb-0">
                                ...
                                <button type="submit" class="btn p-0 border-0 text-danger"><i class="fas fa-heart fa-fw"></i>いいね</button>
                            </form>
                        @endif
                    ...
                    <div class="mr-3 d-flex align-items-center">
                        <a href="{{ url('tweets/' .$tweet->id) }}"><i class="far fa-comment fa-fw"></i>コメント</a>
